...
- **Game Mechanics** — Double jump, air slide, ground slam, combo system, lives system, and all gameplay logic
- **Level Design** — All 10 stages including procedural generation algorithms
- **Enemy AI** — Goomba, Snake, and Ghost behavior patterns
- **Visual Style** — Pixel art aesthetic, parallax backgrounds, particle effects, UI design
- **Audio Design** — Sound effect selection and integration
- **Brand** — FLIPPRX name, logo, and associated branding

### Third-Party Dependencies

This project uses the following open-source tools and libraries under their respective licenses:
...
| [Press Start 2P Font](https://fonts.google.com/specimen/Press+Start+2P) | OFL | Game font |
| [TypeScript](https://www.typescriptlang.org/) | Apache-2.0 | Language |

All third-party dependencies are used in compliance with their respective open-source licenses. No third-party game engines, sprite libraries, or copyrighted assets are used in this project.
...
4. **Commercial Use** — Using the Software or any part of it for profit
5. **Reverse Engineering** — Decompiling, disassembling, or analyzing the Software to extract its design
6. **Asset Extraction** — Extracting, ripping, or reusing any sprites, audio, or visual assets
7. **Cloning** — Creating games that substantially copy the mechanics, design, or aesthetic of this Software
