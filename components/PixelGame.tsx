...
export default function PixelGame() {
      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-green-100 to-green-200 p-2 overflow-hidden">
        <div className="relative rounded-3xl shadow-2xl w-full max-w-md mx-auto" style={{ background: 'linear-gradient(135deg, rgba(55, 65, 81, 0.95) 0%, rgba(75, 85, 99, 0.9) 50%, rgba(55, 65, 81, 0.95) 100%)', padding: 'clamp(1rem, 4vw, 1.5rem)' }}>
          ...
          <div className="flex justify-between items-end">
            {/* D-Pad */}
            <div className="relative" style={{ width: 'clamp(100px, 25vw, 120px)', height: 'clamp(100px, 25vw, 120px)' }}>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative" style={{ width: '100px', height: '100px' }}>
                  {/* Up */}
                  <button
                    className="absolute left-1/2 top-0 -translate-x-1/2 w-8 h-10 bg-gray-800 rounded-t-lg shadow-lg active:bg-gray-700"
                    style={{ opacity: 0.3 }}
                  />
                  {/* Down */}
                  <button
                    className="absolute left-1/2 bottom-0 -translate-x-1/2 w-8 h-10 bg-gray-800 rounded-b-lg shadow-lg active:bg-gray-700"
                    style={{ opacity: 0.3 }}
                  />
                  {/* Left */}
                  <button
                    ...
                    className="absolute left-0 top-1/2 -translate-y-1/2 w-10 h-8 bg-green-900 rounded-l-lg shadow-xl active:bg-green-800 flex items-center justify-center text-white font-bold border-2 border-green-700"
                  ...
                  <button
                    ...
                    className="absolute right-0 top-1/2 -translate-y-1/2 w-10 h-8 bg-green-900 rounded-r-lg shadow-xl active:bg-green-800 flex items-center justify-center text-white font-bold border-2 border-green-700"
                    style={{ userSelect: 'none', WebkitUserSelect: 'none', WebkitTouchCallout: 'none' }}
                  >
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                  ...
                  {/* Center */}
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-gray-900 rounded-full" />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2 items-center">
                <button
                  ...
                  style={{ width: 'clamp(56px, 14vw, 64px)', height: 'clamp(56px, 14vw, 64px)', fontSize: 'clamp(1.25rem, 5vw, 1.5rem)', textShadow: '2px 2px 4px rgba(0,0,0,0.5)', userSelect: 'none', WebkitUserSelect: 'none', WebkitTouchCallout: 'none' }}
                >
                  A
                </button>
                <button
                  ...
                  style={{ width: 'clamp(44px, 11vw, 48px)', height: 'clamp(44px, 11vw, 48px)', userSelect: 'none', WebkitUserSelect: 'none', WebkitTouchCallout: 'none' }}
                >
                  {audioEnabled ? (
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-green-100 via-green-200 to-green-300 overflow-hidden">
      ...
      <div className="bg-white rounded-2xl shadow-2xl border-4 border-green-800 w-full max-w-6xl mx-auto" style={{ padding: 'clamp(1rem, 2vw, 1.5rem)' }}>
        <div className="flex flex-wrap gap-4 items-center justify-center mb-4">
          <div className="font-mono text-yellow-600 bg-green-900 px-4 py-2 rounded-lg font-bold" style={{ fontSize: 'clamp(1rem, 2vw, 1.5rem)' }}>SCORE: {score}</div>
          <div className="font-mono text-cyan-400 bg-green-900 px-4 py-2 rounded-lg font-bold" style={{ fontSize: 'clamp(1rem, 2vw, 1.5rem)' }}>STAGE: {currentStage}/10</div>
          <button
            onClick={() => {
              if (!audioEnabled && bgMusicRef.current && bgMusicRef.current.paused) {
                bgMusicRef.current.play().catch(() => {});
            ...
            className={`px-6 py-2 ${audioEnabled ? 'bg-green-700 hover:bg-green-800' : 'bg-red-600 hover:bg-red-700'} text-white rounded-lg font-bold transition-all transform hover:scale-105 shadow-lg`}
      ...
      <div className="text-center mt-4">
        <div className="bg-white rounded-lg px-6 py-3 inline-block shadow-lg border-2 border-green-800">
          <p className="text-gray-800 font-mono font-semibold" style={{ fontSize: 'clamp(0.75rem, 1.5vw, 1rem)' }}>⬅️ ➡️ Arrow Keys / WASD to move • ⬆️ Space/W/Up to jump</p>
          <p className="text-gray-600 mt-1" style={{ fontSize: 'clamp(0.625rem, 1.25vw, 0.875rem)' }}>Hold jump longer for higher jumps!</p>
        </div>
      </div>
    </div>
  );
