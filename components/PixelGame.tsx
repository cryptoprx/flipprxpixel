            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2 items-center">
                <button
                  ...
                  style={{ width: 'clamp(56px, 14vw, 64px)', height: 'clamp(56px, 14vw, 64px)', fontSize: 'clamp(1.25rem, 5vw, 1.5rem)', textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}
                >
                  A
                </button>
                <button
                  ...
                  style={{ width: 'clamp(44px, 11vw, 48px)', height: 'clamp(44px, 11vw, 48px)', fontSize: 'clamp(0.75rem, 3vw, 0.875rem)' }}
                >
                  {audioEnabled ? '🔊' : '🔇'}
                </button>
              </div>
